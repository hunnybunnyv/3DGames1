...
function createScene() {
    ...
    mirrorMaterial.diffuseColor = new BABYLON.Color3(0.1, 0.1, 0.4);
    ...
    sphereMaterials[7].diffuseTexture = new BABYLON.Texture("images/HK.png", scene);
    ...
    sphereMaterials[7].emissiveColor = new BABYLON.Color3.Magenta;
    sphereMaterials[7].diffuseTexture.vScale *= -5;
    ...
    sphereMaterials[10].ambientColor = new BABYLON.Color3(0, 0, 0);
    sphereMaterials[10].diffuseTexture = new BABYLON.Texture("images/Normal.jpg", scene);
    // sphereMaterials[10].bumpTexture.level = 15.0;


    let camera = new BABYLON.FreeCamera("myCamera", new BABYLON.Vector3(0, 10, -30), scene);
